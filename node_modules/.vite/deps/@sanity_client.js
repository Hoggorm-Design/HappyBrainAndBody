...
var i = c(function(e2) {
  if (!e2) return {};
  for (var t2 = {}, r2 = a2(e2).split("\n"), o3 = 0; o3 < r2.length; o3++) {
    var s3 = r2[o3], n4 = s3.indexOf(":"), i2 = a2(s3.slice(0, n4)).toLowerCase(), u3 = a2(s3.slice(n4 + 1));
    typeof t2[i2] > "u" ? t2[i2] = u3 : (l3 = t2[i2], "[object Array]" === Object.prototype.toString.call(l3) ? t2[i2].push(u3) : t2[i2] = [t2[i2], u3]);
  }
  var l3;
  return t2;
});
...
var h = (e2, t2) => {
  const r2 = e2.options, o3 = e2.applyMiddleware("finalizeOptions", r2), s3 = {}, n4 = e2.applyMiddleware("interceptRequest", void 0, { adapter: l, context: e2 });
  if (n4) {
    const e3 = setTimeout(t2, 0, null, n4);
    return { abort: () => clearTimeout(e3) };
  }
  let a4 = new c2();
  a4 instanceof u && "object" == typeof o3.fetch && a4.setInit(o3.fetch, o3.useAbortSignal ?? true);
  const h2 = o3.headers, d3 = o3.timeout;
  let p3 = false, f = false, b = false;
  if (a4.onerror = (e3) => {
    m(a4 instanceof u ? e3 instanceof Error ? e3 : new Error(`Request error while attempting to reach is ${o3.url}`, { cause: e3 }) : new Error(`Request error while attempting to reach is ${o3.url}${e3.lengthComputable ? `(${e3.loaded} of ${e3.total} bytes transferred)` : ""}`));
  }, a4.ontimeout = (e3) => {
    ...
    d3 && (w2(), s3.socket = setTimeout(() => y("ESOCKETTIMEDOUT"), d3.socket)), !p3 && 4 === a4.readyState && 0 !== a4.status && function() {
      if (!(p3 || f || b)) {
        if (0 === a4.status) return void m(new Error("Unknown XHR error"));
        w2(), f = true, t2(null, { body: a4.response || ("" === a4.responseType || "text" === a4.responseType ? a4.responseText : ""), url: o3.url, method: o3.method, headers: i(a4.getAllResponseHeaders()), statusCode: a4.status, statusMessage: a4.statusText });
      }
    }();
  }, a4.open(o3.method, o3.url, true), a4.withCredentials = !!o3.withCredentials, h2 && a4.setRequestHeader) for (const e3 in h2) h2.hasOwnProperty(e3) && a4.setRequestHeader(e3, h2[e3]);
  return o3.rawBody && (a4.responseType = "arraybuffer"), e2.applyMiddleware("onRequest", { options: o3, adapter: l, request: a4, context: e2 }), a4.send(o3.body || null), d3 && (s3.connect = setTimeout(() => y("ETIMEDOUT"), d3.connect)), { abort: function() {
    p3 = true, a4 && a4.abort();
  } };
  function y(t3) {
    b = true, a4.abort();
...
function l2() {
  if (c3) return a3;
  c3 = 1;
  var e2 = 1e3, t2 = 60 * e2, s3 = 60 * t2, n4 = 24 * s3, r2 = 7 * n4, o3 = 365.25 * n4;
  function i2(e3, t3, s4, n5) {
    var r3 = t3 >= 1.5 * s4;
    return Math.round(e3 / s4) + " " + n5 + (r3 ? "s" : "");
  }
  return a3 = function(a4, c4) {
    c4 = c4 || {};
    var u3, l3, p3 = typeof a4;
    if ("string" === p3 && a4.length > 0) return function(i3) {
      if (!((i3 = String(i3)).length > 100)) {
        var a5 = /^(-?(?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)?$/i.exec(i3);
        if (a5) {
          var c5 = parseFloat(a5[1]);
          switch ((a5[2] || "ms").toLowerCase()) {
            case "years":
            case "year":
            case "yrs":
            case "yr":
    ...
    if ("number" === p3 && isFinite(a4)) return c4.long ? (u3 = a4, (l3 = Math.abs(u3)) >= n4 ? i2(u3, l3, n4, "day") : l3 >= s3 ? i2(u3, l3, s3, "hour") : l3 >= t2 ? i2(u3, l3, t2, "minute") : l3 >= e2 ? i2(u3, l3, e2, "second") : u3 + " ms") : function(r3) {
      var o4 = Math.abs(r3);
      return o4 >= n4 ? Math.round(r3 / n4) + "d" : o4 >= s3 ? Math.round(r3 / s3) + "h" : o4 >= t2 ? Math.round(r3 / t2) + "m" : o4 >= e2 ? Math.round(r3 / e2) + "s" : r3 + "ms";
    }(a4);
    throw new Error("val is not a non-empty string or a valid number. val=" + JSON.stringify(a4));
  };
}
var p2 = function(e2) {
  function t2(e3) {
    ...
    function a4(...e4) {
      ...
      const s4 = a4, r3 = Number(/* @__PURE__ */ new Date()), o4 = r3 - (n5 || r3);
      s4.diff = o4, s4.prev = n5, s4.curr = r3, n5 = r3, e4[0] = t2.coerce(e4[0]), "string" != typeof e4[0] && e4.unshift("%O");
      let i3 = 0;
      e4[0] = e4[0].replace(/%([a-zA-Z%])/g, (n6, r4) => {
        if ("%%" === n6) return "%";
        i3++;
        const o5 = t2.formatters[r4];
        if ("function" == typeof o5) {
          const t3 = e4[i3];
          n6 = o5.call(s4, t3), e4.splice(i3, 1), i3--;
        }
        return n6;
      }), t2.formatArgs.call(s4, e4), (s4.log || t2.log).apply(s4, e4);
    }
    return a4.namespace = e3, a4.useColors = t2.useColors(), a4.color = t2.selectColor(e3), a4.extend = s3, a4.destroy = t2.destroy, Object.defineProperty(a4, "enabled", { enumerable: true, configurable: false, get: () => null !== i2 ? i2 : (r2 !== t2.namespaces && (r2 = t2.namespaces, o3 = t2.enabled(e3)), o3), set: (e4) => {
      i2 = e4;
    } }), "function" == typeof t2.init && t2.init(a4), a4;
  }
  function s3(e3, s4) {
    const n5 = t2(this.namespace + (typeof s4 > "u" ? ":" : s4) + e3);
  ...
  return t2.debug = t2, t2.default = t2, t2.coerce = function(e3) {
    ...
    const e3 = [...t2.names.map(n4), ...t2.skips.map(n4).map((e4) => "-" + e4)].join(",");
    return t2.enable(""), e3;
  }, t2.enable = function(e3) {
    let s4;
    t2.save(e3), t2.namespaces = e3, t2.names = [], t2.skips = [];
    const n5 = ("string" == typeof e3 ? e3 : "").split(/[\s,]+/), r2 = n5.length;
    for (s4 = 0; s4 < r2; s4++) n5[s4] && ("-" === (e3 = n5[s4].replace(/\*/g, ".*?"))[0] ? t2.skips.push(new RegExp("^" + e3.slice(1) + "$")) : t2.names.push(new RegExp("^" + e3 + "$")));
  }, t2.enabled = function(e3) {
    if ("*" === e3[e3.length - 1]) return true;
    let s4, n5;
    for (s4 = 0, n5 = t2.skips.length; s4 < n5; s4++) if (t2.skips[s4].test(e3)) return false;
    for (s4 = 0, n5 = t2.names.length; s4 < n5; s4++) if (t2.names[s4].test(e3)) return true;
    return false;
  }, t2.humanize = l2(), t2.destroy = function() {
    console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`.");
  }, Object.keys(e2).forEach((s4) => {
    t2[s4] = e2[s4];
  }), t2.names = [], t2.skips = [], t2.formatters = {}, t2.selectColor = function(e3) {
    let s4 = 0;
    for (let t3 = 0; t3 < e3.length; t3++) s4 = (s4 << 5) - s4 + e3.charCodeAt(t3), s4 |= 0;
    return t2.colors[Math.abs(s4) % t2.colors.length];
...
var d2 = c(u2.exports);
var w = typeof Buffer > "u" ? () => false : (e2) => Buffer.isBuffer(e2);
function F(e2) {
  return "[object Object]" === Object.prototype.toString.call(e2);
}
function O(e2) {
  if (false === F(e2)) return false;
  const t2 = e2.constructor;
  if (void 0 === t2) return true;
  const s3 = t2.prototype;
  return !(false === F(s3) || false === s3.hasOwnProperty("isPrototypeOf"));
}
var j = ["boolean", "string", "number"];
function v() {
  return { processOptions: (e2) => {
    const t2 = e2.body;
    return !t2 || "function" == typeof t2.pipe || w(t2) || -1 === j.indexOf(typeof t2) && !Array.isArray(t2) && !O(t2) ? e2 : Object.assign({}, e2, { body: JSON.stringify(e2.body), headers: Object.assign({}, e2.headers, { "Content-Type": "application/json" }) });
  } };
}
function x(e2) {
...
var k = R;
function q(e2 = {}) {
  const t2 = e2.implementation || k.Observable;
...
var _$ = class _$ {
  constructor(e2) {
    ...
    this.promise = new Promise((e3) => {
      ...
      this.reason || (this.reason = new N(e3), t2(this.reason));
    });
  }
};
__publicField(_$, "source", () => {
  let e2;
  return { token: new _$((t2) => {
    e2 = t2;
  }), cancel: e2 };
});
var $ = _$;
S.Cancel = N, S.CancelToken = $, S.isCancel = (e2) => !(!e2 || !(e2 == null ? void 0 : e2.__CANCEL__));
var I = (e2, t2, s3) => ("GET" === s3.method || "HEAD" === s3.method) && (e2.isNetworkError || false);
function M(e2) {
  return 100 * Math.pow(2, e2) + 100 * Math.random();
}
var _ = (e2 = {}) => ((e3) => {
  const t2 = e3.maxRetries || 5, s3 = e3.retryDelay || M, n4 = e3.shouldRetry;
...
var z = (H = n3, function(e2 = {}) {
  ...
  return { finalizeOptions: r2, onError: (e3, s4) => {
    if (("GET" === s4.options.method || "POST" === s4.options.method) && e3 instanceof L && "ECONNRESET" === e3.code && e3.request.reusedSocket) {
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-6FTVA4J6.js").then(function(n4) {
...
function _listen(query, params, opts = {}) {
  ...
  return (token || withCredentials) && (esOptions.withCredentials = true), token && (esOptions.headers = {
    ...
    async function getEventSource() {
      const { default: EventSource2 } = await import("./browser-35IKU3WX.js");
      if (unsubscribed)
        return;
...
var LiveClient = class {
  ...
  events({
    ...
    const { apiVersion: _apiVersion, token } = __privateGet(this, _client7).config(), apiVersion = _apiVersion.replace(/^v/, "");
    ...
    const path = _getDataUrl(__privateGet(this, _client7), "live/events"), url = new URL(__privateGet(this, _client7).getUrl(path, false));
    ...
    return includeDrafts && token && (esOptions.headers = {
      ...
      async function getEventSource() {
        const EventSourceImplementation = typeof EventSource > "u" || esOptions.headers ? (await import("./browser-35IKU3WX.js")).default : EventSource;
        if (unsubscribed)
          return;
...
var DatasetsClient = class {
   ...
   */
  delete(name) {
    return lastValueFrom(_modify(__privateGet(this, _client9), __privateGet(this, _httpRequest4), "DELETE", name));
  }
  /**
   * Fetch a list of datasets for the configured project
   */
...
export {
  ...
  requester,
  l as unstable__adapter,
  p as unstable__environment
};
